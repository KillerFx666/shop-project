...
urlpatterns = [
    ...
    path('forgot-password', views.ForgetPasswordView.as_view(), name='forget-password-page'),
    path('reset-password/<active_code>', views.ResetPasswordView.as_view(), name='reset-password-page'),
    path('activate-account/<email_active_code>', views.ActivateAccount.as_view(), name='activate-page'),
